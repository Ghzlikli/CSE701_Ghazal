...
public:
    ...
    {
    public:
        incompatible_format() : invalid_argument("\nThe acceptable format is: \"Key = Value; //any comment if needed\".\n"){};
    };
    ...
    {
    public:
        value_notfound() : invalid_argument("\nValue is not found!\n"){};
    };
    ...
    {
    public:
        num_invalid() : invalid_argument("\nThe requested number is not valid and cannot be converted!\n"){};
    };
...
double config::get_value(const string &key, const double &default_v)
{
    ...
    {
        cout << "The parameter " << key << " is not defined in the configuration file; + the default value of "
             << default_v << " is used.\n";
        return default_v;
    }
